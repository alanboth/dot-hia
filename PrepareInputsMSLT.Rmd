...
"General life table", "Population numbers and mortality rates", "Population Greater Melbourne (@RN2) by 5-year age groups and sex and death rates by single year of age and sex (@RN1)", "Mortality rates were calculated as the average of deaths over three years (2016-2018) divided by the population for the baseline year (2017) as per (@Carmichael2016)", 
...
For this study we used population data for Greater Melbourne (**check these data may change with Vista people data**) and no further calculations were requiered from the source data. The code to calculate death rates per one is providce below (*calculateDeathRates*) along with graphs to check results. 
