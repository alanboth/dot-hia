...
```{r, echo=FALSE, out.width="50%", fig.cap="Figure 1: Baseline mode of transport"}
...
```{r, echo=FALSE, out.width="50%", fig.cap="Figure 2: Baseline distance by mode of transport"}
...
<!-- ![Figure 1: Transport mode share Melbourne](SuppDocs/StagesGraphs/TripsModeBaseline.png) ![Figure 2: Transport mode share Melbourne](SuppDocs/StagesGraphs/TripsModeDistCat.png) -->
...
$$
\begin{align}
 PIF_d= \frac {RR_{d-baseline} - RR_{d-scenario}} {RR_{d-baseline}}
\end{align}
$$
**Relative risks**
...
```{r image_grobs, fig.show = "hold", echo=FALSE, out.width="40%", fig.cap="Figure 4: Relative risks for modelled diseases", fig.align = "default"}
...
analytical_framework <- grViz("digraph{
                      ...
                      color = black, overlap = true, height = 400, width = 400]
                      ...
                      edge[color = Black, arrowhead = normal, arrowtail = none, tailport= 'e', headport= 'w']
                         ...
                         subgraph cluster_0 {
                          graph[shape = rectangle, fontsize = 400]
                          style = rounded
                          bgcolor = WhiteSmoke
                          face = bold
                          fontname = Calibri
                          ...
                          label = 'Data sources'
                            ...
                            1[label = 'VISTA 2017-2018']
                            2[label = 'NHS 2017-18, Basic CURF']
                            3[label = 'SEIFA INDEX']
                   ...
                   {rank = same; 4;5;6;7;8;9}
                       ...
                       subgraph cluster_2 {
                          ...
                          label = 'Generated data sets to match'
                            ...
                            10[label = 'Persons transport (n=7,117)']
                            11[label = 'Persons Leisure and work (n=16,370)']
                          ...
                          label = ''
                            ...
                            18[label = 'mMET-hours per person']
...
PMSLT_graph  %>% export_svg %>%
charToRaw %>%
rsvg_png("presentation/pmslt.png")
```
