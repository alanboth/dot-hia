...
matched_population_computation <- tribble(
~Component, ~"Matching variable", ~"VISTA", ~"NHS",
"Age",
"Sex",
...
kable(matched_population, booktabs = T, caption = "Table 2: Matched poplation computation", longtable = TRUE) %>%
