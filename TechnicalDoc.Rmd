...
$$PIF = { \frac{ -({ Prevalence_{scenario} - Prevalence_{baseline}}) * (RR - 1)} {Prevalence_{baseline} * (RR -1) +1}  }$$ 
...
For ischemic heart disease and stroke, we calculated the combined PIF given that these diseases have two risk factors in the model: physical inactivity and type 2 diabetes. 
