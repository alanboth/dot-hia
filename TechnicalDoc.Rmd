...
"Age", "All ages, 18-19, 20-24, 25-29, 30-34, 35-39, 40-44, 45-49, 50-54, 55-59, 60-64, 65-69, 70-74, 75-79, 80-84, 85-89, 90-94, 95-98", "All ages, 15-19, 20-24, 25-29, 30-34, 35-39, 40-44, 45-49, 50-54, 55-59, 60-64, 65-69, 70-74, 75-79, 80-84, 85-89, 90-94, 95-99",
...
We created a matched population to derive individual mMET-hours per week based on the Victorian Integrated Survey of Travel and Activity 2017-2018 (VISTA 2017-18 @RN20) and national survey data collected for physical activity surveillance (National Health Survey (NHS), @RN22). PA data from the NHS were allocated to each VISTA individual. MET-hours per individual were derived from the sum of the product of hours spent weekly doing transport walking, transport cycling, vigorour PA for leisure and work, moderate PA for leisure and work and walking for leisure by their corresponding mMET-hours. Tranport walking and cycling were sourced from the VISTA survey and the rest from the NHS (Table 2).
We used the latest VISTA survey conducted across the period 2017-18 for Greater Melbourne and Geelong. For this study we limited the analysis to the Greater Melbourne area for the period 2017-18, which included 3,543 households, 7,117 individuals and 23,166 trips. Walking and cycling minutes for each of the VISTA persons (n=7,117) were derived by summing up all time spent walking and cycling during the survey day multiplied by 5 if the trips took place on a weekday or 2 if it took place on a weekend day. Walking and cycling levels were summed up at the stage level (i.e. a trip may consist of multiple stages).  The NHS is a representative sample of Australian adults. The data were collected by the Australian Bureau of Statistics and published as the National Health Survey, 2017-18, Basic-CURF [@RN22]. A sample of 21,315 adults was available. Minutes spent doing moderate physical activity for leisure and work, vigorous physical activity for leisure and work, walking for leisure during the a week were collected. The three categories are mutually exclusive [@RN24] and were translated to hours per week. Survey respondents were asked about the time they spent doing physical activity in the last week, including walking for transport, walking for recreation, moderate physical activity (excludes walking) and vigorous physical activity. A walking session was only to be recorded if the duration of the session was at least 10 minutes.
Total mMETs per person for the BAU scenario were derived by translating minutes spent in each of the domains per week to hours and then multiplying by the MET scores [@RN21] minus one. Tables 3 outlines all types of PA activities included, by source, and correspoinding assigned MET values. VISTA individuals were matched to NHS individuals based on age, sex, socio-economic status, whether they walk for transport and work status (see Table 3).  
  
```{r, echo=FALSE, include=TRUE}

mets <- tribble(
~"Physical activity", ~"Survey", ~"METs", "Source",
...
### Some graphs here for distribution of physical actiity comparing melbourne modle and Australia models
### Travel behaviour
